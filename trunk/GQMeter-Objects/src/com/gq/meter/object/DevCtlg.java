...
// default package
// Generated Jul 10, 2013 1:45:27 PM by Hibernate Tools 3.4.0.CR1
...
public class DevCtlg implements java.io.Serializable {
    ...
    public DevCtlg(String ctlgId, String protocolId, String descr, short idleThreshold, short loadThreshold,
            ...
            Integer noOfCore, Double cpu, Integer ram, Integer diskGb, Integer monthlyRent, Short idlePctg,
            Short fullPctg, Double fullWatt) {
        this.ctlgId = ctlgId;
        this.protocolId = protocolId;
        this.descr = descr;
        this.idleThreshold = idleThreshold;
