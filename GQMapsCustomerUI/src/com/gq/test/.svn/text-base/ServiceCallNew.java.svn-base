...
//		                   .get(ClientResponse.class);
				...
				.queryParam("goalId", "pue").queryParam("entpId", "servion")
				.queryParam("goalInputs","__date__=2013-10-16~__asset_id__=C-000c293c937a").get(ClientResponse.class);
				...
				System.out.println("Output new  from Server .... \n");
