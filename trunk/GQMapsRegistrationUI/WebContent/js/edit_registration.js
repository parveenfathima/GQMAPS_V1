...
{		
	...
	var formEntp = new enterprise(dbEntp.getSId(), eid, ename, uid, pwd, output, url, empCount, eSqft, eAsset, dSqft, dAsset, dcUsed, dcTemp, comments, active, regStatus, dbEntp.getMCount(), dbEntp.getExpDate());
                                            //sid, eid, ename, uid, pwd, output, url, empCount, eSqft, eAsset, dSqft, dAsset, dcUsed, dcTemp,  comments, active, regStatus, mcount, expDate)   
...
function enterprise(sid, eid, ename, uid, pwd, output, url, empCount, eSqft, eAsset, dSqft, dAsset, dcUsed, dcTemp,  comments, active, regStatus, mcount, expDate)   
{
	this.sid = sid;
	this.eid = eid;
	this.ename = ename;
...
enterprise.prototype.toString = function()  
{
	...
	return(this.eid + ", " + this.ename + ", " + this.uid + ", " + this.pwd + ", " + this.output + ", " + this.url + ", " + this.empCount + ", "+ this.eSqft + ", " + this.eAsset + ", " + this.dSqft + ", " + this.dAsset + ", " + this.dcUsed + ", " + this.dcTemp + ", " + this.comments + ", " +this.active + ", " + this.regStatus + ", " + this.mcount + ", " + this.expDate);
