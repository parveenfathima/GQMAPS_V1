...
public class GetAssetServiceConstant {
    // logger specifics
    public static final Logger logger = Logger.getLogger("GetAssetServiceConstant.class");

    private static FileAppender fileappender;
    private static String logFilePrefix = "/opt/gq/maps/logs/";
    private static String logFileName = "getassetservices.log";
    ...
    static {
        ...
        GetAssetServiceConstant.logger.info("initializing gqmaps GetAssetServices logger..."); // ???? !!!!!!
        ...
        try {
            ...
            e.printStackTrace();
            GetAssetServiceConstant.logger.error("************ Unable to create LOG file handle for file  " + logFile
