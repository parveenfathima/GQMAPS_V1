<%@page import = "com.gq.AssetData"%>
<%@page import = "com.gq.ui.object.DomainData"%>
<%@page import = "java.util.*"%> 
<%@page import = "com.gq.meter.object.*"%>
...
<html>
	...
	<head>
		...
		<script src = "js/plugins/tables/jquery.dataTables.min.js" type = "text/javascript"> </script>
		...
		<div id = "container">
			...
			<div class = "wrapper">
				...
				<h5 class = "widget-name">
					<i class = "icon-file"> </i> Asset Edit for <%=entp%> 
				</h5>
								...
								<tbody>
									...
									<tr style = "font-size:80%;">
										...
										<td style = "width:50px;">
											...
											<select name = <%="cmbStatus" + i%> id = <%="cmbStatus" + i%> class = "styled" 
											...
											%>
												...
												<option value = "<%=(char) aryStatus[status]%>" selected = "selected">
													<%=activeStatus[status]%>
												</option>
												
											<% } else {%>
												
												<option value = "<%=(char) aryStatus[status]%>">
													<%=activeStatus[status]%>
												</option>
										...
										<td style = "width:100px; ">
											...
											<span id = <%="assetID" + i%> name = <%="assetID" + i%>> 
										...
										<td style = "width:90px; ">
											...
											<span id = <%="ipAddr" + i%> name = <%="ipAddr" + i%>> 
										...
										<td style = "width:70px; height:20px;">
											...
											<select name = <%="cmbCatalog" + i%> id = <%="cmbCatalog" + i%> class = "styled" 
											...
											%>
												...
												<option value = "<%=compCatalogListDB.get(catalog).getId()%>" selected = "selected">
													<%=compCatalogListDB.get(catalog).getDesc()%>
												</option>
										...
										<td style = "width:80px; height:20px;">
											...
											<select name = <%="cmbSrvrApp" + i%> id = <%="cmbSrvrApp" + i%> class = "styled" 
											style = "width:110px; height:20px;" >
											...
											%>
												...
												<option value = "<%=srvrAppListDB.get(srvr).getId()%>" selected = "selected">
													<%=srvrAppListDB.get(srvr).getDesc()%>
												</option>
										...
										<td style = "width:100px; height:20px;">
											...
											value = "<%=assetListDB.get(i).getAssetUsg()%>" maxlength = "50"  
											class = "input-small" placeholder = "Asset Usage">
											
										</td>
										
										<td style = "width:60px; height:20px;">
											
											<select name = <%="cmbImpLevel" + i%> id = <%="cmbImpLevel" + i%> class = "styled" 
											...
											%>
												...
												<option value = "<%=assetImpLevelListDB.get(impl).getId()%>" selected = "selected">
													<%=assetImpLevelListDB.get(impl).getDesc()%>
												</option>
										...
										<td style = "width:80px; height:20px;">
											...
											<select name = <%="cmbOwnership" + i%> id = <%="cmbOwnership" + i%> class = "styled" 
											...
											%>
												...
												<option value = "<%=aryOwnership[ownership]%>" selected = "selected">
													<%=aryOwnership[ownership]%>
												</option>
											
											<% } else { %>
											
												<option value = "<%=aryOwnership[ownership]%>">
													<%=aryOwnership[ownership]%>
												</option>
										...
										<td style = "width:60px; height:20px;">
											...
											<select name = <%="cmbLocation" + i%> id = <%="cmbLocation" + i%> class = "styled" 
											style = "width:70px; height:20px;" >
											...
											%>
												...
												<option value = "<%=aryLocation[loc]%>" selected = "selected">
													<%=activeLocation[loc]%>
												</option>
											
											<% } else { %>
											
												<option value = "<%=aryLocation[loc]%>">
													<%=activeLocation[loc]%>
												</option>
										...
										<td style = "width:70px; height:20px;">
											...
											<select name = <%="cmbCompType" + i%> id = <%="cmbCompType" + i%> class = "styled" 
												style = "width:70px; height:20px;" >
											...
											%>
												...
												<option value = "<%=compTypeListDB.get(comp).getId()%>" selected = "selected">
													<%=compTypeListDB.get(comp).getDesc()%>
												</option>
									...
									<tr style = "font-size:80%;">
										...
										<td style = "width:90px; height:20px;">
											...
											%>
												...
												<option value = "<%=printerCatalogListDB.get(catalog).getId()%>" selected = "selected">
													<%=printerCatalogListDB.get(catalog).getDesc()%>
												</option>
										...
										<td style = "width: 60px; display: none;">
											...
											<input type = "text" id = <%="cmbSrvrApp" + i%> name = <%="cmbSrvrApp" + i%> 
											disabled = "disabled" hidden = "hidden" value = "null" style = "width: 100px;" />
										...
										<td style = "width: 100px; display: none;">
												...
												<input type = "text" name = <%="cmbCompType" + i%> id = <%="cmbCompType" + i%> 
												disabled = "disabled" hidden = "hidden" value = "null" style = "width: 100px;" />
									...
									<tr style = "font-size:80%;">
										...
										<td style = "width:100px; height:20px;">
											...
											%>
												...
												<option value = "<%=nsrgCatalogListDB.get(catalog).getId()%>" selected = "selected">
													<%=nsrgCatalogListDB.get(catalog).getDesc()%>
												</option>
										...
										<td style = "display: none;">
											...
											<input type = "text" id = <%="cmbSrvrApp" + i%> name = <%="cmbSrvrApp" + i%> 
											disabled = "disabled" value = "null" hidden = "hidden" style = "width: 100px;" />
										...
										<td style = "display: none;">
											...
											<input type = "text" id = <%="cmbImpLevel" + i%> name = <%="cmbImpLevel" + i%> 
											disabled = "disabled" value = "null" hidden = "hidden" style = "width: 100px;" />
										...
										<td style = "display: none;">
											...
											disabled = "disabled" value = "null" style = "width: 100px;" />
										</td>
				...
				<div class = "span6 well body " style = "height:50px;">
					...
					<button class = "btn btn-success" type = "button" id = "submit" name = "submit" style = "position:relative; top:7px; left:10px;" 
					onClick = "updateAsset(<%=assetListDB.size()%>);"> Submit </button>
					
					<button class = "btn btn-warning" type = "button" style = "position:relative; top:7px; left:20px;" 
