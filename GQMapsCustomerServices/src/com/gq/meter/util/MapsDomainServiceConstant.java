...
public class MapsDomainServiceConstant {

    // logger specifics
    public static final Logger logger = Logger.getLogger("MapsDomainServiceConstant.class");

    private static FileAppender fileappender;
    private static String logFilePrefix = "/opt/gq/maps/logs/";
    private static String logFileName = "mapsdomainservices.log";
    ...
    static {
        ...
        MapsDomainServiceConstant.logger.info("initializing gqmaps MapsDomainServices logger..."); // ???? !!!!!!
        ...
        try {
            ...
            e.printStackTrace();
            MapsDomainServiceConstant.logger.error("************ Unable to create LOG file handle for file  " + logFile
